...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_helpers__ = __webpack_require__(40);
/**
 * Main imports.
 */
...
window.BootstrapSass = __webpack_require__(42);

window.getBaseUrl = __WEBPACK_IMPORTED_MODULE_2__app_helpers__["a" /* getBaseUrl */];

window.isMobile = __WEBPACK_IMPORTED_MODULE_2__app_helpers__["b" /* isMobile */];

window.loadDynamicScript = __WEBPACK_IMPORTED_MODULE_2__app_helpers__["c" /* loadDynamicScript */];

window.showAlert = __WEBPACK_IMPORTED_MODULE_2__app_helpers__["e" /* showAlert */];
...
// Expose isAxiosError
axios.isAxiosError = __webpack_require__(39);
...
/* harmony export (immutable) */ __webpack_exports__["c"] = loadDynamicScript;
/* harmony export (immutable) */ __webpack_exports__["e"] = showAlert;
/* harmony export (immutable) */ __webpack_exports__["d"] = removeTrailingSlash;
function getBaseUrl() {
...
function showAlert(messageType, messageLabel, message) {
    if (messageType && message !== '') {
        ...
        var html = '<div class="alert ' + messageType + ' alert-dismissible" id="' + alertId + '">\n            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>\n                <strong>' + (messageLabel ? messageLabel + '!' : '') + ' </strong> ' + message + '.\n        </div>';
