        ...
        <section class="row col-12 velocity-divide-page category-page-wrapper">
            <div class="col-12 no-padding">
                <div class="hero-image">
                    ...
                    <img class="logo" src="{{ asset('/themes/kiddyzone/assets/images/banners/listing.png') }}" alt="" width="100%" height="auto" />
                    @endif
                </div>
            ...
            <div class="row remove-padding-margin braedcom">
            ...
            <div class="catagory-two container-fluid row">
            ...
            <div class="category-container right col-lg-9">
