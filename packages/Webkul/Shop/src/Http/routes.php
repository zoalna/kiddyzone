...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
    ...
    /*EST Start*/
        Route::get('/refer-a-friend', 'Webkul\Shop\Http\Controllers\HomeController@ReferAfriend')->defaults('_config', [
            'view' => 'shop::home.refer-a-friend'
        ])->name('shop.home.refer-a-friend');
        Route::post('/refer-a-friend', 'Webkul\Shop\Http\Controllers\HomeController@ReferAfriend')->defaults('_config', [
            'view' => 'shop::home.refer-a-friend'
        ])->name('shop.home.refer-a-friend');
    /*EST End*/

    Route::get('/mysterybox', 'Webkul\Shop\Http\Controllers\HomeController@mysterybox')->defaults('_config', [
        'view' => 'shop::home.mystery-box'
    ])->name('shop.home.mystery-box');
    
    Route::get('/giftcards', 'Webkul\Shop\Http\Controllers\HomeController@giftcards')->defaults('_config', [
        'view' => 'shop::home.gift-cards-toys'
    ])->name('shop.home.gift-cards-toys');

    Route::get('/loyalty-program-terms', 'Webkul\Shop\Http\Controllers\HomeController@loyaltyProgram')->defaults('_config', [
        'view' => 'shop::home.program'
    ])->name('shop.home.program');
    
    Route::get('/subscribtion-and-card', 'Webkul\Shop\Http\Controllers\HomeController@subscribtionAnd')->defaults('_config', [
        'view' => 'shop::home.subscribtion-and-card'
    ])->name('shop.home.subscribtion-and-card');

    Route::get('/subscription-card-form', 'Webkul\Shop\Http\Controllers\HomeController@subscriptionCardform')->defaults('_config', [
        'view' => 'shop::home.subscription-card-form'
    ])->name('shop.home.subscription-card-form');
    /**
     * Store front search.
     */
    ...
    // Render Rates
    Route::get('/checkout/render-rates', 'Webkul\Shop\Http\Controllers\OnepageController@renderRates')->name('shop.checkout.render-rates');
     
    // Render Payment
     Route::get('/checkout/render-payments', 'Webkul\Shop\Http\Controllers\OnepageController@renderPaymentMethod')->name('shop.checkout.render-payments');
 
    // Render Order Review
     Route::get('/checkout/render-orderreview', 'Webkul\Shop\Http\Controllers\OnepageController@renderOrderReview')->name('shop.checkout.render-orderreview');
    ...
    Route::group(['middleware' => ['cart.merger']], function () {
        ...
        Route::prefix('customer')->group(function () {
            ...
            Route::post('login', 'Webkul\Customer\Http\Controllers\SessionController@create')->defaults('_config', [
                'redirect' => 'customer.deshbroad.index'
            ...
            Route::group(['middleware' => ['customer']], function () {
                ...
                Route::prefix('account')->group(function () {
                     ...
                     * Profile.
                     */
                    Route::get('deshbroad', 'Webkul\Customer\Http\Controllers\AddressController@deshbroad')->defaults('_config', [
                        'view' => 'shop::customers.account.deshbroad.index'
                    ])->name('customer.deshbroad.index');
                    ...
                    Route::get('profile/changepassword', 'Webkul\Customer\Http\Controllers\CustomerController@changepassword')->defaults('_config', [
                        'view' => 'shop::customers.account.profile.change-password'
