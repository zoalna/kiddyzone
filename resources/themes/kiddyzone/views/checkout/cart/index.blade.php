        ...
        <div class="container cart-page">
            ...
            <div class="total">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="{{ url('/checkout/cart') }}">Cart</a></li>
                    </ol>
                </div>
            </div>
            ...
            <section class="cart-details row col-12 cart-page">
                ...
                {!! view_render_event('bagisto.shop.checkout.cart.summary.after', ['cart' => $cart]) !!}
                    ...
                    @if ($cart)
                        <div class="col-lg-4 col-md-12 row order-summary-containers " style="background: #F6F6F6;">
                            @include('shop::checkout.total.summary-cart', ['cart' => $cart])
