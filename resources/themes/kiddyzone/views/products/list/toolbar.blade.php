...
@push('scripts')
    <script type="text/x-template" id="toolbar-template">
        <div class="toolbar-wrapper listing-top" v-if='!isMobile()'>
            ...
            <div class="product-sorting">
                ...
                <div class="limiter">
                    ...
                    <select class="selective-div border-normal styled-select" onchange="window.location.href = this.value" aria-label="Show">
