...
<div class="layered-filter-wrapper left col-lg-3">
...
@push('scripts')
    ...
    <script type="text/x-template" id="filter-attribute-item-template">
        <div :class="`cursor-pointer active filter-attributes-item ${active ? 'active' : ''}`">
        ...
        <div class="cursor-pointer active filter-attributes-item custom">
            <div class="filter-attributes-title custom">
                <h6 class="fw6 display-inbl">TOP RATED</h6>
            </div>
            <div class="filter-attributes-content custom">
                @include('velocity::home.list-page-hotsell')
            </div>
        </div>
    </script>
