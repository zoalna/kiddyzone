    ...
    <form
        ...
        <div class="account-table-content">
            ...
            <div :class="`row ${errors.has('first_name') ? 'has-error' : ''}`">
                ...
                <div class="col-12">
                    <input placeholder="First Name" value="{{ $customer->first_name }}" name="first_name" type="text" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.customer.account.profile.fname') }}&quot;" />
                    <span class="control-error" v-if="errors.has('first_name')" v-text="errors.first('first_name')"></span>
                    <div class="input-icon nice"><img src="{{ asset('/themes/kiddyzone/assets/images/Icon feather-user.svg') }}"></div>
                </div>
            </div>
            ...
            <div :class="`row ${errors.has('last_name') ? 'has-error' : ''}`">
                ...
                <div class="col-12">
                    <input placeholder="Last Name" value="{{ $customer->last_name }}" name="last_name" type="text" v-validate="'required'" data-vv-as="&quot;{{ __('shop::app.customer.account.profile.lname') }}&quot;" />
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <input placeholder="Email Address" value="{{ $customer->email }}" name="email" type="text" v-validate="'required'" />
                    <span class="control-error" v-if="errors.has('email')" v-text="errors.first('email')"></span>
                    <div class="input-icon"><img src="{{ asset('/themes/kiddyzone/assets/images/Icon-material-email.svg') }}"></div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div :class="`col-12 ${errors.has('oldpassword') ? 'has-error' : ''}`">
                    <input placeholder="Password" value="" name="oldpassword" type="password" />
                    <div class="input-icon"><img src="{{ asset('/themes/kiddyzone/assets/images/Icon-awesome-eye.svg') }}"></div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div :class="`col-12 ${errors.has('password_confirmation') ? 'has-error' : ''}`">
                    <input value="" name="password_confirmation" placeholder="Confirm Password" type="password"
