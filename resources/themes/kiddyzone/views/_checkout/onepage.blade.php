...
@push('scripts')
    ...
    <script type="text/x-template" id="checkout-template">
        ...
        <div class="top-banner">
            <div class="page-title"><h1>Check Out Here</h1></div>
            <img src="{{ asset('/themes/kiddyzone/assets/images/banners/checkout-banner.jpg') }}" alt="listing-banner" class="img-responsive">
        </div>
        </div>
